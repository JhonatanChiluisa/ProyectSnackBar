													...
													if ($res == true) {
														...
														if ($numFilas > 0) {
															while ($fila = mysqli_fetch_assoc($res)) {
																$idMen = $fila['men_id'];
                                                                $id = $fila['bar_id'];
																$nombreMen = $fila['men_nombre'];
                                                                $precioMen = $fila['men_precio'];
                                                                $disponibleMen = $fila['men_disponible'];
                                                                $descripcionMen = $fila['men_descripcion'];
																
													?>
																<tr>
                                                                    <td><?php echo $idMen ?></td>
																	<td><?php echo $id ?></td>
																	<td><?php echo $nombreMen  ?></td>
																	<td><?php echo $precioMen  ?></td>
                                                                    <td><?php echo $disponibleMen  ?></td>
                                                                    <td><?php echo $descripcionMen  ?></td>
															...
															?>
															<tr>
																<td colspan="6">Aún no se han creado registros</td>
															</tr>
													<?php
														}
													}
