				...
				<div class="page-block">
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html"><i class="feather icon-package"></i></a></li>
													...
													if ($res == true) {
														...
														if ($numFilas > 0) {
															while ($fila = mysqli_fetch_assoc($res)) {
																$idSna = $fila['sna_id'];
                                                                $id = $fila['bar_id'];
																$nombre = $fila['sna_nombre'];
                                                                $precio = $fila['sna_precio'];
                                                                $disponible = $fila['sna_disponible'];
																
													?>
																<tr>
                                                                    <td><?php echo $idSna ?></td>
																	<td><?php echo $id ?></td>
