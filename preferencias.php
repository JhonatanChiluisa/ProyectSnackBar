				...
				<div class="page-block">
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html"><i class="feather icon-heart"></i></a></li>
								<li class="breadcrumb-item"><a href="#!">Bar ESPEL BDD</a></li>
								<li class="breadcrumb-item"><a href="#!">Preferencias</a></li>
							</ul>
						</div>
					</div>
				</div>
													...
													if ($res == true) {
														...
														if ($numFilas > 0) {
															while ($fila = mysqli_fetch_assoc($res)) {
																$idMen = $fila['men_id'];
                                                                $id = $fila['pre_id'];
																$fecha = $fila['pre_fecha'];
																$observacion = $fila['pre_observacion'];
